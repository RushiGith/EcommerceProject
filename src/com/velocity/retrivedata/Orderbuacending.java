...
public class Orderbuacending {

	public void acending(){
		try {
			Connectionjdbc retrive= new Connectionjdbc();
			Connection con = retrive.getconnection();
			PreparedStatement prs = con.prepareStatement("select id,productname,price,discription from insertdata.product order by productname limit 0,10");
